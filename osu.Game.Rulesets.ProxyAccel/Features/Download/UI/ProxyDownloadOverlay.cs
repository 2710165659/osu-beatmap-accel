...
public partial class ProxyDownloadOverlay : Container
{
    private readonly APIBeatmapSet beatmapSet;

    private ProxyBeatmapDownloadTracker tracker = null!;
    private bool useToolbarHeight = true;

    [Resolved]
    private OsuGame game { get; set; } = null!;

    public ProxyDownloadOverlay(APIBeatmapSet beatmapSet)
    {
    ...
    private void load(OsuColour colours)
    {
            ...
            new FillFlowContainer
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    buttonFlow = new FillFlowContainer
                    {
                        ...
                        Anchor = Anchor.TopCentre,
                        Origin = Anchor.TopCentre,
                        Child = new ProxyDownloadButton(beatmapSet)
                    }
                }
            }
        };
        ...
        if (beatmapSet.HasVideo)
            buttonFlow.Add(new ProxyDownloadButton(beatmapSet, true));
    ...
    protected override void UpdateAfterChildren()
    {
        ...
        {
            ProxyLogging.LogError(e, "Unable to read toolbar position");
